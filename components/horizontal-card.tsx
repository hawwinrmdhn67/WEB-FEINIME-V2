    ...
    >
      <div className="flex flex-col h-full rounded-xl overflow-hidden bg-card border border-border/50 shadow-sm w-full">
        ...
        <div className="relative w-full aspect-[2/3] overflow-hidden">
          ...
          {/* Rating */}
          {anime.score && (
            <div className="absolute top-2 left-2 flex items-center bg-black/60 backdrop-blur-sm text-yellow-400 text-xs font-semibold p-1.5 rounded-full shadow-md">
          ...
          <div className="absolute bottom-0 left-0 w-full p-4 z-10">
            <h3 className="font-bold text-primary-foreground text-lg sm:text-xl line-clamp-2 drop-shadow-md group-hover/card:text-primary transition-colors">
              {anime.title}
            </h3>
