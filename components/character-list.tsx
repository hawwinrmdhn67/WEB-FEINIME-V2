...
export const CharacterList = ({ animeId }: { animeId: number }) => {
  ...
  useEffect(() => {
    getAnimeCharacters(animeId).then(data => setCharacters(data ?? []))
  }, [animeId])
        ...
        {characters.map(char => {
          ...
          return (
            <div
              ...
              className="group relative bg-card rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all z-10"
            >
              <div className="relative aspect-[3/4] w-full overflow-hidden rounded-t-lg">
                <Image
                  ...
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-300 gpu-accelerate"
              ...
              <div className="p-3">
                ...
                {va && (
                  <div className="mt-1 flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <span className="text-[9px] px-1 rounded opacity-70">
                      JP
                    </span>
                  </div>
                )}
