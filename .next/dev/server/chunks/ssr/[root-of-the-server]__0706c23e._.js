...
;
async function Home() {
    const heroData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTopAnime"])(1);
    const heroAnimes = heroData?.data ? heroData.data.slice(0, 5) : [];
    const popularData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPopularAnime"])(1);
    const popularAnimes = popularData?.data || [];
    const trendingData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTopAnime"])(1);
    const trendingAnimes = trendingData?.data ? trendingData.data.slice(5, 25) : [];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0706c23e._.js.map