...
"[project]/app/seasonal/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SeasonalPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SeasonalPage.useEffect": ()=>{
            const fetchSeasonal = {
                "SeasonalPage.useEffect.fetchSeasonal": async ()=>{
                    setLoading(true);
                    try {
                        const [res1, res2] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSeasonNow"])(1),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSeasonNow"])(2)
                        ]);
                        const combined = [
                            ...res1.data || [],
                            ...res2.data || []
                        ];
                        const unique = Array.from(new Map(combined.map({
                            "SeasonalPage.useEffect.fetchSeasonal.unique": (a)=>[
                                    a.mal_id,
                                    a
                                ]
                        }["SeasonalPage.useEffect.fetchSeasonal.unique"])).values());
                        setAnimes(unique);
                    } catch (err) {
            ...
            }["SeasonalPage.useEffect.fetchSeasonal"];
            fetchSeasonal();
        }
    }["SeasonalPage.useEffect"], []);
...
_s(SeasonalPage, "9JVwM/VAT3RF4CDmX3exVXa+GTg=");
_c = SeasonalPage;
var _c;
__turbopack_context__.k.register(_c, "SeasonalPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_6ce9e6e6._.js.map