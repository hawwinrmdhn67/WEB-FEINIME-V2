...
// PENTING: Menambahkan 'use' ke impor React
...
;
;
const Image = ({ src, alt, fill, className, width, height, priority })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
        src: src,
        alt: alt,
        className: className,
        style: {
            ...
            height: fill ? '100%' : height ? `${height * 4 / 3}px` : undefined
        },
        loading: priority ? 'eager' : 'lazy',
        onError: (e)=>{
            e.currentTarget.onerror = null;
            e.currentTarget.src = 'https://placehold.co/300x400/4b5563/ffffff?text=Image+Not+Found';
        }
    }, void 0, false, {
...
_c = Image;
const Button = ({ children, variant = 'primary', className = '', disabled, onClick, href, ...props })=>{
    const baseClasses = "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 h-10 px-4 py-2 shadow-md";
    let variantClasses = "bg-indigo-600 text-white hover:bg-indigo-700"; // Default (primary)
    if (variant === 'outline') {
        variantClasses = "border border-indigo-600 text-indigo-600 bg-white hover:bg-indigo-50 transition-colors";
    }
...
const Navbar = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "p-4 bg-white/90 backdrop-blur-md border-b border-gray-200 shadow-sm fixed w-full top-0 left-0 z-50",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "max-w-6xl mx-auto text-xl font-extrabold text-gray-800",
            children: "Anime Detail Viewer"
        }, void 0, false, {
            fileName: "[project]/app/anime/[id]/page.tsx",
            lineNumber: 94,
            columnNumber: 9
...
_c2 = Navbar;
// --- FUNGSI API JIKAN SEBENARNYA ---
const JIKAN_BASE_URL = 'https://api.jikan.moe/v4/anime/';
/**
 * Mengambil detail anime dari Jikan API menggunakan ID.
 * @param id ID MAL anime
 * @returns Promise yang berisi objek Anime atau null
 */ async function getAnimeDetail(id) {
    const url = `${JIKAN_BASE_URL}${id}/full`;
    console.log(`Fetching anime details from: ${url}`);
    try {
        const response = await fetch(url);
        // Jikan API mengembalikan status 404 jika ID tidak ditemukan
        if (response.status === 404) {
            console.error(`Anime with ID ${id} not found (404).`);
            return null;
        }
        if (!response.ok) {
        ...
        // Jikan API membungkus data dalam properti 'data'
        return json.data;
    } catch (error) {
        console.error('Error fetching data from Jikan API:', error);
        return null; // Mengembalikan null pada kegagalan API
    }
}
// --- END API FUNCTION ---
// --- UTILITY FUNCTIONS ---
...
const getTrailerEmbedUrl = (trailer)=>{
    // Jikan API v4 biasanya memberikan embed_url, kita ambil itu
    if (trailer?.embed_url) {
        return trailer.embed_url;
    }
    // Fallback jika hanya URL biasa yang tersedia
    if (trailer?.url && trailer.url.includes('youtube.com')) {
        // Coba konversi URL YouTube biasa ke format embed (sangat sederhana)
        try {
...
const RelatedContent = ({ relations })=>{
    // relations dijamin array oleh calling component (AnimePage)
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-3",
                children: relations.map((rel, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-col gap-1 p-3 bg-white rounded-lg border border-gray-200 shadow-sm",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "font-semibold text-indigo-600 min-w-[120px]",
                                children: [
                                    rel.relation,
                                    ":"
                                ]
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: rel.entry.map((entry)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                        href: entry.url || `#${entry.mal_id}`,
                                        className: "text-gray-500 text-sm hover:text-indigo-600 hover:underline transition-colors flex items-center gap-1",
                                        target: "_blank",
                                        rel: "noopener noreferrer",
                                        children: [
...
_c3 = RelatedContent;
// Komponen Pembantu untuk menampilkan Staf dan Studio
const ProductionDetails = ({ studios, staff })=>{
    // FIX: Gunakan (staff || []) untuk memastikan 'staff' adalah array sebelum memanggil filter.
    const staffArray = staff || [];
    // Filter staff untuk hanya menampilkan posisi kunci seperti Director, Producer, dll.
    const keyPositions = [
        'Director',
        'Series Composition',
        'Original Creator',
    ...
    const filteredStaff = staffArray.filter((member)=>keyPositions.includes(member.position));
    if ((!studios || studios.length === 0) && filteredStaff.length === 0) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "px-4 sm:px-6 lg:px-8",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                className: "text-2xl font-bold text-gray-800 mb-4",
                children: "Produksi & Staf Kunci"
            }, void 0, false, {
                fileName: "[project]/app/anime/[id]/page.tsx",
                lineNumber: 250,
                columnNumber: 13
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                className: "font-bold text-lg mb-2 text-indigo-600",
                                children: "Studio"
                            }, void 0, false, {
                                fileName: "[project]/app/anime/[id]/page.tsx",
                                lineNumber: 255,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: studios && studios.length > 0 ? studios.map((studio)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-2",
                                children: filteredStaff.length > 0 ? filteredStaff.slice(0, 5).map((member, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-gray-800 flex justify-between",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                className: "text-gray-500 font-medium mr-2 min-w-[120px]",
                                                children: [
                                                    member.position,
                                                    ":"
                                                ]
                                    ...
                                    }, member.person.mal_id || index, true, {
                                        fileName: "[project]/app/anime/[id]/page.tsx",
                                        lineNumber: 275,
                                        columnNumber: 33
                                    }, ("TURBOPACK compile-time value", void 0))) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-gray-500",
                                    children: "Data Staf tidak tersedia."
                                }, void 0, false, {
                                    fileName: "[project]/app/anime/[id]/page.tsx",
                                    lineNumber: 281,
                                    columnNumber: 29
...
_c4 = ProductionDetails;
// Komponen Daftar Karakter
const CharacterList = ({ characters })=>{
    // FIX: Gunakan (characters || []) untuk memastikan 'characters' adalah array
    const charactersArray = characters || [];
    // Hanya ambil 8 karakter pertama untuk efisiensi dan tata letak
    const displayedCharacters = charactersArray.slice(0, 8);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                className: "text-2xl font-bold text-gray-800 mb-4",
                children: "Karakter & Pengisi Suara"
            }, void 0, false, {
                fileName: "[project]/app/anime/[id]/page.tsx",
                lineNumber: 302,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: displayedCharacters.map((charData)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200 transition-transform hover:shadow-xl duration-300",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: `absolute top-2 right-2 px-2 py-1 text-xs font-medium rounded-full text-white ${charData.role === 'Main' ? 'bg-red-500' : 'bg-gray-700'}`,
                                        children: charData.role
                                    }, void 0, false, {
                                        fileName: "[project]/app/anime/[id]/page.tsx",
                                        lineNumber: 318,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-bold text-gray-800 truncate flex items-center gap-1",
                                        children: [
                                    ...
                                    charData.voice_actors.find((va)=>va.language === 'Japanese') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: charData.voice_actors.find((va)=>va.language === 'Japanese')?.person.name
                                            }, void 0, false, {
                                                fileName: "[project]/app/anime/[id]/page.tsx",
                                                lineNumber: 336,
                                                columnNumber: 23
                    ...
                    }, charData.character.mal_id, true, {
                        fileName: "[project]/app/anime/[id]/page.tsx",
                        lineNumber: 306,
                        columnNumber: 11
                    }, ("TURBOPACK compile-time value", void 0)))
...
const StatCard = ({ icon, label, value })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-col items-center md:items-start gap-1 bg-white p-3 rounded-lg border border-gray-200 shadow-sm text-center md:text-left transition-shadow hover:shadow-lg",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: "text-base md:text-lg font-extrabold text-gray-800 truncate w-full",
                children: value
            }, void 0, false, {
                fileName: "[project]/app/anime/[id]/page.tsx",
                lineNumber: 361,
...
_c6 = StatCard;
function AnimePage({ params }) {
    _s();
    // START FIX FOR CONSOLE ERROR (from previous issue): A param property was accessed directly with params.id
    // 1. Unwrap the potentially async 'params' object using the React 'use' hook.
    ...
    // 2. Gunakan 'resolvedParams' untuk mendapatkan 'id' yang aman.
    const routeParams = resolvedParams;
    // Fallback ID default adalah '50265' (Spy x Family) untuk memastikan ada data saat pertama kali dimuat
    const safeId = routeParams?.id || '50265';
    // END FIX
    ...
    const [showFullSynopsis, setShowFullSynopsis] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimePage.useEffect": ()=>{
            const routeId = parseInt(safeId);
            ...
            async function fetchData() {
                try {
                    setLoading(true);
                    setError(null);
                    const data = await getAnimeDetail(routeId);
                    if (!data) {
                        setError(`Anime with ID ${routeId} not found.`);
                    }
                    setAnime(data);
                } catch (err) {
                    console.error('Failed to fetch anime:', err);
                    setError("Failed to connect to Anime API.");
                } finally{
                    setLoading(false);
                }
            }
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "text-gray-800 text-lg mt-20 flex items-center gap-2",
                    children: [
                        ...
                        "Mengambil Data Anime Real-Time..."
                    ]
                }, void 0, true, {
                    fileName: "[project]/app/anime/[id]/page.tsx",
                    lineNumber: 425,
    ...
    if (error || !anime) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            className: "min-h-screen bg-gray-50 flex flex-col items-center justify-center pt-20 text-center p-4",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Navbar, {}, void 0, false, {
                    fileName: "[project]/app/anime/[id]/page.tsx",
                    lineNumber: 436,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-red-50 border border-red-200 p-6 rounded-xl shadow-lg mt-20",
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: error || "Anime data could not be retrieved."
                        }, void 0, false, {
                            fileName: "[project]/app/anime/[id]/page.tsx",
                            lineNumber: 439,
                            columnNumber: 17
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Coba ganti ID di URL rute (misal: `/anime/21` untuk One Punch Man) atau refresh halaman."
                        }, void 0, false, {
                            fileName: "[project]/app/anime/[id]/page.tsx",
                            lineNumber: 440,
                            columnNumber: 17
    ...
    // --- PREPARASI DATA (Setelah dipastikan anime tidak null) ---
    const imageUrl = anime.images?.jpg?.large_image_url || 'https://placehold.co/1280x720/374151/ffffff?text=Background+Placeholder';
    const titleEnglish = anime.title_english || anime.title;
    const score = anime.score != null ? anime.score.toFixed(2) : 'N/A';
    const episodes = anime.episodes?.toString() ?? 'TBA';
    const source = anime.source || 'N/A';
    const year = anime.year?.toString() ?? 'TBA';
    const trailerEmbedUrl = getTrailerEmbedUrl(anime.trailer);
    const genres = anime.genres ?? [];
    const synopsis = anime.synopsis || 'No synopsis available.';
    const airedDates = anime.aired?.string || 'TBA';
    const relations = anime.relations ?? [];
    const characters = anime.characters ?? [];
    // Logika Collapsible Synopsis
    const MAX_SYNOPSIS_LENGTH = 500;
    const needsTruncation = synopsis.length > MAX_SYNOPSIS_LENGTH;
    const displayedSynopsis = needsTruncation && !showFullSynopsis ? synopsis.substring(0, MAX_SYNOPSIS_LENGTH) + '...' : synopsis;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        className: "min-h-screen bg-gray-50 overflow-x-hidden text-gray-800 font-sans",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Navbar, {}, void 0, false, {
                fileName: "[project]/app/anime/[id]/page.tsx",
                lineNumber: 470,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative h-112 md:h-128 w-full overflow-hidden pt-[64px]",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Image, {
                        src: imageUrl,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute inset-0 bg-gradient-to-t  from-gray-50 via-gray-50/20 to-transparent"
                    }, void 0, false, {
                        fileName: "[project]/app/anime/[id]/page.tsx",
                        lineNumber: 483,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "shadow-2xl rounded-xl overflow-hidden border-4 border-white group transition-transform duration-500 hover:scale-105",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Image, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "md:col-span-2 text-center md:text-left flex flex-col justify-center gap-4 pt-4 md:pt-0",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                className: "text-3xl md:text-5xl font-extrabold text-gray-900 drop-shadow-md leading-tight",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 mt-4",
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatCard, {
                                        ...
                                        label: "Rank Populer",
                                        value: anime.popularity != null ? `#${formatNumber(anime.popularity)}` : 'N/A'
                                    }, void 0, false, {
                                        fileName: "[project]/app/anime/[id]/page.tsx",
                                        lineNumber: 529,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    trailerEmbedUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Button, {
                                        href: trailerEmbedUrl,
                                        className: "gap-2",
                                        children: [
                                        ...
                                        disabled: true,
                                        className: "gap-2 bg-gray-300 text-gray-600 cursor-not-allowed",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$play$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Play$3e$__["Play"], {
                                                size: 18
                                            }, void 0, false, {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Button, {
                                        variant: "outline",
                                        className: "gap-2",
                                        onClick: ()=>console.log('Added to Favorites (Dummy)'),
                                        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative max-w-6xl mx-auto mt-8 md:mt-12 space-y-12 pb-16",
                children: [
                    genres.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: genres.map((genre)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "px-3 py-1 bg-indigo-50 border border-indigo-200 text-indigo-700 text-sm font-medium rounded-full transition-colors hover:bg-indigo-100",
                                children: genre.name
                            }, genre.mal_id, false, {
                                fileName: "[project]/app/anime/[id]/page.tsx",
                                lineNumber: 571,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    needsTruncation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "mt-3 p-0 h-auto text-indigo-600 font-semibold hover:text-indigo-700 transition-colors bg-transparent border-none",
                                        children: showFullSynopsis ? 'Baca Sedikit' : 'Baca Selengkapnya'
                                    }, void 0, false, {
                                        fileName: "[project]/app/anime/[id]/page.tsx",
                                        lineNumber: 589,
                                        columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-gray-600 bg-white p-5 rounded-lg border border-gray-200 shadow-sm",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductionDetails, {
                    ...
                    characters.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CharacterList, {
                    ...
                    relations.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RelatedContent, {
                        relations: relations
                    }, void 0, false, {
                        fileName: "[project]/app/anime/[id]/page.tsx",
                        lineNumber: 615,
...
_s(AnimePage, "ba4iDs34djuAIDsDWHnSTgA9scs=");
_c7 = AnimePage;
var _c, _c1, _c2, _c3, _c4, _c5, _c6, _c7;
__turbopack_context__.k.register(_c, "Image");
__turbopack_context__.k.register(_c1, "Button");
__turbopack_context__.k.register(_c2, "Navbar");
__turbopack_context__.k.register(_c3, "RelatedContent");
__turbopack_context__.k.register(_c4, "ProductionDetails");
__turbopack_context__.k.register(_c5, "CharacterList");
__turbopack_context__.k.register(_c6, "StatCard");
__turbopack_context__.k.register(_c7, "AnimePage");
...
//# sourceMappingURL=_23a9f92f._.js.map