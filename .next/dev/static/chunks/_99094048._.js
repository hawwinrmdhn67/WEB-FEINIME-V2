...
function AnimeActionButtons({ animeId, trailerUrl }) {
    ...
    // ===================== FETCH STATUS =====================
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimeActionButtons.useEffect": ()=>{
            const fetchStatus = {
                "AnimeActionButtons.useEffect.fetchStatus": async ()=>{
                    try {
            ...
            }["AnimeActionButtons.useEffect.fetchStatus"];
            fetchStatus();
        }
    }["AnimeActionButtons.useEffect"], [
        animeId
...
_s(AnimeActionButtons, "mhjAsxs6u9XF3xIzktKCfLGGX7I=");
