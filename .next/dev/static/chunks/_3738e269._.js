...
"[project]/components/horizontal-preview-carousel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "HeroCarousel.useEffect": ()=>{
            ...
            const interval = setInterval({
                "HeroCarousel.useEffect.interval": ()=>{
                    setIndex({
                        "HeroCarousel.useEffect.interval": (prev)=>(prev + 1) % animes.length
                    }["HeroCarousel.useEffect.interval"]);
                }
            }["HeroCarousel.useEffect.interval"], 4500);
            return ({
...
//# sourceMappingURL=_3738e269._.js.map