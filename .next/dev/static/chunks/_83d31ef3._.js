...
async function AnimePage({ params }) {
    ...
    const animeId = id // Gogoanime pakai string ID
    ;
    if (!animeId) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notFound"])();
    let anime = null;
    try {
    ...
    if (!anime) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notFound"])();
    // Mapping fields ke UI lama
    const imageUrl = anime.image || '/placeholder.svg';
    const titleEnglish = anime.otherName || '-';
    const score = '-' // Gogoanime tidak punya rating
    ;
    const episodes = anime.episodes ?? 'TBA';
    const status = anime.status || '-';
    const year = anime.released || 'TBA';
    const genres = (anime.genres || []).map((g, index)=>({
            mal_id: index,
            name: g
        }));
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        variant: "outline",
                                        className: "gap-2 border-primary text-primary hover:bg-primary/15 hover:text-primary dark:hover:bg-primary/25 dark:hover:text-primary",
                                        children: [
...
_c1 = StatCard;
// ======= MOCK FUNCTION =======
// Ganti dengan fetch dari Gogoanime API
async function getAnimeDetail(animeId) {
    const res = await fetch(`https://api.gogoanime.consumet.org/anime-details/${animeId}`);
...
//# sourceMappingURL=_83d31ef3._.js.map