		...
		<section className="px-4 sm:px-6 lg:px-8">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
				{relations.map((rel, index) => (
					// Card Content: rounded-lg statis + z-10
					<div key={index} className="bg-card rounded-lg overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-shadow z-10">
		...
		<section className="px-4 sm:px-6 lg:px-8">
			...
			<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
				{characters.map((char) => {
					...
					return (
						// Card Wrapper: rounded-lg statis + z-10
						<div key={char.character.mal_id} className="group relative bg-card rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all focus:outline-none z-10">
							{/* Perbaikan: TAMBAH rounded-t-lg pada div pembungkus gambar */}
	...
	return (
		<section className="px-4 sm:px-6 lg:px-8">
			...
			<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
				{/* Card Stat: rounded-xl statis + z-10 + hover shadow */}
		...
		<section className="px-4 sm:px-6 lg:px-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				{reviews.map((review, idx) => (
					// Card Review: rounded-xl statis + z-10 + hover shadow
					<div key={idx} className="bg-card rounded-xl p-5 flex flex-col gap-4 hover:shadow-md transition-shadow shadow-sm focus:outline-none z-10 gpu-accelerate">
		...
		<main className="min-h-screen bg-background overflow-x-hidden">
			...
			<div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 md:-mt-48 grid grid-cols-1 md:grid-cols-3 gap-8 pb-12">
				...
				<div className="relative w-full max-w-[240px] mx-auto md:mx-0 aspect-[2/3]">
					{/* Tambah gpu-accelerate pada elemen yang memiliki hover:scale-105 */}
				...
				<div className="md:col-span-2 text-center md:text-left flex flex-col justify-end gap-4 pb-2">
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-2">
						{/* Info Card: rounded-lg statis + z-10 */}
			...
			<div className="relative max-w-6xl mx-auto mt-4 space-y-12 pb-20">
				...
				{/* Airing Details - Sudut Melengkung Statis: rounded-xl */}
				<section className="px-4 sm:px-6 lg:px-8">
