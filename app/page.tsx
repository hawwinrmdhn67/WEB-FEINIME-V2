    ...
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* LEFT COLUMN: HERO CARDS (TOP 1 & 2) */}
          ...
          {/* RIGHT COLUMN: SIDEBAR LIST (TOP 3 - 7) */}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        <span className="text-[10px] font-bold px-1.5 py-0.5 bg-secondary rounded text-muted-foreground border border-border/50">
                          {anime.type}
                        </span>
                        <span className="text-xs text-muted-foreground flex items-center gap-1">
                          <Star size={10} className="text-yellow-500 fill-yellow-500" /> {anime.score}
                        </span>
                      </div>
                    </div>
                  </Link>
      ...
      {/* --- LIST SECTIONS (Seasonal & Popular) --- */}
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm">Anime currently airing this season</p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
            {seasonalAnime.map((anime) => (
              // PERBAIKAN: Hapus Link wrapper, gunakan key di AnimeCard
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm">Fan favorites highly rated series</p>
            </div>
