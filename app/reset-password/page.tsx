          ...
          <div className="bg-card border border-border/50 rounded-2xl shadow-md p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
              ...
              <div>
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/70 w-4 h-4" />

                  <input
                    type={showPassword ? 'text' : 'password'}
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                    className="w-full pl-10 pr-10 py-3 rounded-lg bg-input border border-border/40 text-sm focus:outline-none focus:ring-1 focus:ring-primary hover:bg-input"
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-primary text-primary-foreground flex items-center justify-center gap-2 disabled:opacity-60 hover:bg-primary/95"
              >
            ...
            <div className="text-center mt-6 text-sm">
              <p className="text-muted-foreground">
                Remember your password? <Link href="/login" className="text-primary hover:opacity-80">Sign in</Link>
              </p>
            </div>
          </div>
        </div>
