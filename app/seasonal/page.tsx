...
export default function SeasonalPage() {
  ...
  useEffect(() => {
    const fetchSeasonal = async () => {
      setLoading(true)
      try {
        const [res1, res2] = await Promise.all([getSeasonNow(1), getSeasonNow(2)])
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center md:text-left mb-10">
          <h1 className="text-4xl font-bold mb-2 text-foreground">Seasonal Anime</h1>
          <p className="text-muted-foreground">Catch up with the latest anime currently airing right now</p>
        </div>
